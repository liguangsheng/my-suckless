...
static const char *dmenucmd[]     = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_prim, "-sf", col_gray1, "-h", dmenuheight, "-p", "RUN", "-h", "20", NULL };
static const char *termcmd[]      = { "alacritty", NULL };
static const char *rofiruncmd[]   = { "rofi", "-show", "run",  "-theme-str", "*{primary:#13a4b6;background:#282c34;}", NULL};
static const char *rofidruncmd[]  = { "rofi", "-show", "drun", "-theme-str", "*{primary:#13a4b6;background:#282c34;}", NULL};
static const char *wallpapercmd[] = { "random_wallpaper.py", NULL};
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_p,      spawn,          {.v = wallpapercmd} },
